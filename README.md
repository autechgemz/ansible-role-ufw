...
ufw_policy_data:
  - { ensure: 'present', policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '22'   }
  - { ensure: 'absent',  policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '636'  }
  - { ensure: 'absent',  policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '3128' }
  - { ensure: 'absent',  policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '8080' }
  - { ensure: 'absent',  policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '443'  }
  - { ensure: 'absent',  policy: 'allow', proto: 'tcp', direction: 'in', interface: '', from: 'any', to: 'any', port: '8443' }
```
